...
const { startPointerDrag } = useTaskDrag(() => props.calendarId);
  ...
  <div class="flex h-full min-h-0 flex-col text-foreground">
    ...
    <div class="min-h-0 flex-1 overflow-y-auto">
      <section>
        ...
        <div
          v-show="tasksExpanded || taskDragStore.active"
          data-drop-zone="tasks"
          class="min-h-[2rem] transition-colors"
        >
      ...
      <section class="border-t border-border">
        ...
        <div
          v-show="stampsExpanded || taskDragStore.active"
          data-drop-zone="stamps"
          class="min-h-[2rem] transition-colors"
        >
          <TaskListItem
